...
public class StructureHouse extends StructurePandoraBase
{
	private static final String STRUCTTYPE = "house.nbt";
    ...
    public StructureHouse(int type, int belongness, EnumFacing streetFacing, int x, int z)
    {
